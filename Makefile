...
patch:
	...
	export MINTOS_DIR=`cat .makedata` MINTOS_DAT=`pwd` && cd $$MINTOS_DIR && cd frameworks/base && git apply $$MINTOS_DAT/06-frameworks_base-3.patch || true # This patch is probably broken, don't abort patching through
