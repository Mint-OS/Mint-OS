...
genota:
	export MINTOS_DIR=`cat .makedata` MINTOS_DAT=`pwd` MINTOS_DEVICE=`cat .makedata2` && cd $$MINTOS_DIR/out/target/product/$$MINTOS_DEVICE/ && chmod +x $$MINTOS_DAT/mkota-wrapper.sh && $$MINTOS_DAT/mkota-wrapper.sh lineage-17.1-*.zip ota_metadata $$MINTOS_DEVICE
