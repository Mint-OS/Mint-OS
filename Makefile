...
patch:
	...
	-export MINTOS_DIR=`cat .makedata` MINTOS_DAT=`pwd` && cd $$MINTOS_DIR && cd packages/apps/PermissionController && git apply -v $$MINTOS_DAT/04-packageinstaller.patch && echo OK
